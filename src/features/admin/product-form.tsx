  ...
  return (
    <form action={action} className="mt-8 space-y-5 rounded-3xl border border-stone-200 bg-white p-6 lg:p-8">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <label className="text-sm font-medium">库存<input name="stock" type="number" min={0} step={1} defaultValue={product?.stock ?? 0} required disabled={pending} className={fieldClass} /><ErrorText errors={state.fieldErrors} name="stock" /></label>
      </div>
